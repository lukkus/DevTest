...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20210911110001_Add_Job_Customer_Relation")]
    partial class Add_Job_Customer_Relation
    {
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            JobId = 1,
                            Engineer = "Test",
                            When = new DateTime(2021, 9, 11, 13, 0, 0, 749, DateTimeKind.Local).AddTicks(2413)
                        });
                });
